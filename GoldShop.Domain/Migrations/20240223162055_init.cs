    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFactors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductFactors_Factors_FactorId",
                        column: x => x.FactorId,
                        principalTable: "Factors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductFactors_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFactors_FactorId",
                table: "ProductFactors",
                column: "FactorId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductFactors_ProductId",
                table: "ProductFactors",
                column: "ProductId");
